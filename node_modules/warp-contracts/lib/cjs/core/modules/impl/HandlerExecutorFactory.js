...
exports.HandlerExecutorFactory = exports.AbortError = exports.NonWhitelistedSourceError = exports.ContractError = void 0;
...
class AbortError extends Error {
    constructor(error) {
        super(error.toString());
        this.error = error;
        this.name = JsHandlerApi_1.KnownErrors.AbortError;
    }
}
    ...
    async create(contractDefinition, evaluationOptions, warp, interactionState) {
        ...
        if (contractDefinition.contractType == 'wasm') {
            ...
            if (warp.hasPlugin('vm2')) {
                ...
                const quickJsPlugin = warp.loadPlugin('quickjs');
