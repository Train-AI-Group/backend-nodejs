...
class WarpGatewayContractDefinitionLoader {
    ...
    async load(contractTxId, evolvedSrcTxId) {
        try {
            ...
            const result = await (0, utils_1.getJsonResponse)(this._warpFetchWrapper.fetch(`${baseUrl}/gateway/contract?txId=${contractTxId}${evolvedSrcTxId ? `&srcTxId=${evolvedSrcTxId}` : ''}`));
    ...
    set warp(warp) {
        ...
        this._warpFetchWrapper = new WarpFetchWrapper_1.WarpFetchWrapper(warp);
    }
}
