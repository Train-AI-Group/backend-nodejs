...
class HandlerBasedContract {
    ...
    async writeInteraction(input, options) {
        ...
        const effectiveInputFormatOption = options === null || options === void 0 ? void 0 : options.inputFormatAsData;
    ...
    async bundleInteraction(input, options) {
        ...
        const interactionDataItem = await this.createInteractionDataItem(input, options.tags, CreateContract_1.emptyTransfer, options.strict, options.vrf, options.manifestData, options.inputFormatAsData);
    ...
    async createInteractionDataItem(input, tags, transfer, strict, vrf = false, manifestData, inputFormatAsData) {
        var _a;
        ...
        let data;
        if ((0, warp_arbundles_1.tagsExceedLimit)(interactionTags) || inputFormatAsData) {
            interactionTags = [
